...
export const repos: RepoCatalog[] = [
  ...
  {
    name: "Caption Brunch",
    repo: "MithunXcpu/caption-brunch",
    githubUrl: "https://github.com/MithunXcpu/caption-brunch",
  ...
  {
    name: "SignalRoom",
    repo: "MithunXcpu/signalroom-prototype",
    githubUrl: "https://github.com/MithunXcpu/signalroom-prototype",
  ...
  {
    name: "BYOS",
    repo: "MithunXcpu/byos",
    githubUrl: "https://github.com/MithunXcpu/byos",
    summary: "DevSecOps tool management dashboard for monitoring security scans, policies, and tool health.",
    appIdea: "StackGuard — a security posture dashboard that auto-discovers every tool in your stack, runs vulnerability scans, and enforces policies.",
    category: "passion",
  },
  {
    name: "GuideDot",
    repo: "MithunXcpu/guidedot",
    githubUrl: "https://github.com/MithunXcpu/guidedot",
    summary: "Sales enablement platform for managing guided demo flows, talk tracks, and battle cards.",
    appIdea: "DemoOS — an interactive demo builder where SEs upload enablement docs and AI generates guided product walkthroughs.",
    category: "interview",
  },
  {
    name: "PilotDrop",
    repo: "MithunXcpu/pilotdrop",
    githubUrl: "https://github.com/MithunXcpu/pilotdrop",
    summary: "Community-driven show pitching and voting platform for greenlighting content.",
    appIdea: "PitchPad — a platform where creators pitch show concepts, audiences vote, and winning ideas get funded.",
    category: "passion",
  },
  {
    name: "Link Vault",
    repo: "MithunXcpu/link-vault",
    githubUrl: "https://github.com/MithunXcpu/link-vault",
    summary: "Curated collection of tweets, GitHub repos, and dev tools from AI conversations, categorized with app ideas.",
    appIdea: "DevBookmark — a social bookmarking tool where AI auto-categorizes saved links and suggests project integrations.",
    category: "infra",
  },
];
